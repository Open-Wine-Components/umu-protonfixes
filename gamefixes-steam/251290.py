...
def main() -> None:
    config_path = (
        Path(util.protonprefix())
        / 'drive_c/users/steamuser/Saved Games/FALCOM/ED_SORA2/ed6_win2.ini'
    )
    ...
    try:
        ...
        log.warn(f"Failed to create Trails in the Sky SC config at '{config_path}': {e}")
